    ...
    ?>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-8"><h3 class="azul">Controle de Acessos - Grupo Gagliardi</h3></div>
            </div>
        </div>
    <?php
    }
...
<nav class="navbar navbar-expand-lg navbar-dark fundo-azul">
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            ...
            <span class="nav-link text-white"><b>|</b></span>
            <a class="nav-link text-white" href="index.php?action=novo&control=movimentacao">Registrar Entrada</a>
            <span class="nav-link text-white"><b>|</b></span>

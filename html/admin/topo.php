        <h3 class="azul">Centro de Administração - Controle de Acessos - Grupo Gagliardi</h3>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fundo-azul">
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <span class="nav-link text-white"><b>|</b></span>
                    <a class="nav-link text-white" href="index.php?action=portarias&control=portaria">Recepções</a>
                    <span class="nav-link text-white"><b>|</b></span>
